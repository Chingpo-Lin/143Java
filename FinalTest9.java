...
class LinkedIntList {
    public LinkedIntList removeSmaller() {
        if (front != null && front.next != null) {
           LinkedIntList smaller = new Linked
           ListNode small = front.next;
           if (front.data > small.data) {
           ...
           ListNode temp3 = small;
           while (temp2 != null && temp2.next != null && temp2.next.next != null) {
              if (temp2.next.data > temp2.next.next.data) {
                 ListNode temp4 = temp2.next.next;
                 temp2.next.next = temp2.next.next.next;
                 temp4.next = null;
                 temp3.next = temp4;
                 temp3 = temp3.next;
                 temp3 = temp2.next;
              }else {
                 ListNode temp5 = temp2.next;
